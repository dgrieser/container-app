...
[`android/buildSrc/src/main/kotlin`](android/buildSrc/src/main/kotlin). Nothing needs to be
...
The Gradle build lives in [`android/`](android); `app-variants.yaml` and
`app-icons/` stay at the repository root because the iOS app reads them too.
